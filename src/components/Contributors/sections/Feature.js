      ...
      <div
        ...
        <div
          ...
          <div className="md:w-1/2 mt-8 md:mt-0 text-center md:text-left">
            ...
            <div className="inline-block mt-8 text-primary border-b-2 uppercase">
              <a href="https://gosocial.io" target="_blank" rel="noopener noreferrer">100+ Creative Challenges</a>
            </div>
          </div>
          <div className="md:w-1/2">
            <img className="w-3/4 md:w-9/12 lg:w-4/5 xl:w-auto mx-auto" src={empowerImg} alt=""/>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-24">
         ...
         <div
          className="flex flex-col-reverse md:flex-row justify-center items-center mt-24 sm:mt-32 xl:ml-24">
          <div className="md:w-1/2 mt-8 md:mt-0 text-center md:text-left">
            <h2 className="font-black text-2xl md:text-3xl lg:text-4xl italic leading-tight">Connect with new audience</h2>
            <p className="text-lg sm:text-xl leading-tight mt-4">
