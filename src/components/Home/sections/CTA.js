  ...
  return (
    <section className="mt-32 lg:px-6 xl:px-0">
      <div
        ...
        className="sm:px-10 lg:container bg-black text-white lg:mx-auto py-32 lg:rounded-lg lg:shadow-2xl text-center relative bg-left-bottom bg-no-repeat">
        ...
        <form className="max-w-4xl flex flex-col md:flex-row mx-auto mt-16 text-lg flex-wrap">
          ...
          <input className="mt-4 md:mt-0 flex-grow bg-primary py-4 px-6 rounded" type="submit" value="Request Invite"/>
        </form>
