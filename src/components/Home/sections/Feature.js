...
const Feature = () => {
  return (
    <section>
      <div className="max-w-5xl mx-auto mt-40 md:px-10 lg:px-20 xl:px-0">
        {/* Reward Section */}
        <div className="flex justify-center items-center">
          ...
          <div className="w-1/2">
            ...
            <p className="md:text-2xl lg:text-3xl leading-tight mt-4">
        ...
        <div className="flex justify-center items-center mt-32">
          <div className="w-1/2">
            ...
            <p className="md:text-2xl lg:text-3xl text-3xl leading-tight mt-4">
            Upgrade to orange account and reward your favorite creators with every like.
            </p>
          </div>
          <div className="w-1/2 text-right">
           <img className="md:w-9/12 lg:w-4/5 xl:w-auto inline-block" src={suppdImg} alt=""/>
          </div>
        </div>
      </div>
    </section>
