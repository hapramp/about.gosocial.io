      ...
      <div className="max-w-5xl mx-auto sm:h-screen flex flex-col items-center relative justify-center px-6 sm:px-10 xl:px-0 mb-32" >
        <div className="flex flex-col sm:flex-row">
          <div className="sm:w-1/2 mt-64 sm:mt-20">
            ...
            <div className="mt-16">
              <a href="https://play.google.com/store/apps/details?id=com.gosocial" className="text-white shadow sm:shadow-none mt-4 md:mt-0 flex-grow bg-primary py-4 px-6 rounded cursor-pointer" target="__new">
